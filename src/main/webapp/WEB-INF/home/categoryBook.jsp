    ...
    <div class="shopMain" id="shopmain">
                        ...
                        <li>
                            <div class="list ">
                                <a href="book.action?bookId= ${book.id}">
                                    ...
                                    <div class="pro-title ">分类：<c:out value="${categoryBookPageDto.categoryName}"></c:out></div>
                                </a>
                            </div>
                        </li>
        ...
        <div class="tres">
            ...
            <c:if test="${categoryBookPageDto.pageNumber>1}">
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=1">首页</a>
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber-1}">上一页</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber<=categoryBookPageDto.lastPage}">
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber}">${categoryBookPageDto.pageNumber}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber+1<=categoryBookPageDto.lastPage}">
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber+1}">${categoryBookPageDto.pageNumber+1}</a>
            </c:if>


            <c:if test="${categoryBookPageDto.pageNumber+2<=categoryBookPageDto.lastPage}">
            <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber+2}">${categoryBookPageDto.pageNumber+2}</a>
            </c:if>


            <c:if test="${categoryBookPageDto.pageNumber+3<=categoryBookPageDto.lastPage}">
            <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber+3}">${categoryBookPageDto.pageNumber+3}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber+4<=categoryBookPageDto.lastPage}">
            <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber+4}">${categoryBookPageDto.pageNumber+4}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber<categoryBookPageDto.lastPage}">
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.pageNumber+1}">下一页 </a>
                <a href="category.action?categoryId=${categoryBookPageDto.categoryId}&&pageNumber=${categoryBookPageDto.lastPage}">末页 </a>
            </c:if>
