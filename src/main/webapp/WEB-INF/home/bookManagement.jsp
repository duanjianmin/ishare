    ...
    <div class="shopMain" id="shopmain">
        ...
        <div class="tres">
            ...
            <c:if test="${categoryBookPageDto.pageNumber>1}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=1">首页</a>
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber-1}">上一页</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber<=categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber}">${categoryBookPageDto.pageNumber}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber+1<=categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber+1}">${categoryBookPageDto.pageNumber+1}</a>
            </c:if>


            <c:if test="${categoryBookPageDto.pageNumber+2<=categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber+2}">${categoryBookPageDto.pageNumber+2}</a>
            </c:if>


            <c:if test="${categoryBookPageDto.pageNumber+3<=categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber+3}">${categoryBookPageDto.pageNumber+3}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber+4<=categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber+4}">${categoryBookPageDto.pageNumber+4}</a>
            </c:if>

            <c:if test="${categoryBookPageDto.pageNumber<categoryBookPageDto.lastPage}">
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.pageNumber+1}">下一页 </a>
                <a href="management.action?bookName=${categoryBookPageDto.bookName}&&pageNumber=${categoryBookPageDto.lastPage}">末页 </a>
            </c:if>
